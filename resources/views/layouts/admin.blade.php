       ...
       <button type="submit" class="btn search-btn btn-primary" value="Search"><i class="fas fa-search"></i></button> 
                        ...
                        <div class="app-utilities col-auto">
                            ...
                            <div class="app-utility-item app-user-dropdown dropdown">
                                <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
                                    ...
                                    @if (auth()->user()->image)
                                        <img src="assets/images/user.png" class="rounded-circle" alt="user profile">
                                    @else
        ...
        <div id="app-sidepanel" class="app-sidepanel">
            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <div class="app-branding p-0">
                    <a class="app-logo" href="{{ url('/') }}">
                        <img class="logo-icon d-block mx-auto my-2" src="{{ asset('images/green_log.png') }}"
                            alt="logo">
                    ...
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            <a href="" class="nav-link">
                                ...
                                <span class="nav-link-text">Tramites</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link">
                                ...
                                <span class="nav-link-text">Consultas UIF</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link">
                                ...
                                <span class="nav-link-text">Registro de actividades</span>
                            </a>
                        </li>
    ...
    <div class="app-wrapper">
        ...
        <footer class="app-footer">
            <div class="container text-center py-3">
                ...
                <small class="copyright">Desarrollado <i class="fas fa-heart" style="color: #fb866a;"></i> por
                    <a class="app-link" href="http://themes.3rdwavemedia.com" target="_blank">Witann Technologies</a></small>
